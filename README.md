...
2023-12-16 21:52:10.239 [DEBUG]: [smartshop-session] {'ts': 1702763530239, 'session_id': '978d646d0d8340b9923733ebe22cb952', 'client_id': 'User_50', 'status': 1, 'shop_id': 'SHOP_80'}
...
2023-12-16 21:52:58.407 [DEBUG]: [smartshop-session] {'ts': 1702763578406, 'session_id': '978d646d0d8340b9923733ebe22cb952', 'client_id': 'User_50', 'status': -1, 'shop_id': 'SHOP_80'}
2023-12-16 21:52:58.407 [DEBUG]: [smartshop-session] {'ts': 1702763578407, 'session_id': '759c1c73a8e942c0a0344b28bff01be0', 'client_id': 'User_63', 'status': 1, 'shop_id': 'SHOP_53'}
...
2023-12-16 21:53:29.515 [DEBUG]: [smartshop-session] {'ts': 1702763609515, 'session_id': '759c1c73a8e942c0a0344b28bff01be0', 'client_id': 'User_63', 'status': -1, 'shop_id': 'SHOP_53'}
2023-12-16 21:53:29.516 [DEBUG]: [smartshop-session] {'ts': 1702763609515, 'session_id': '646660cc080b4e32a0b391914c885702', 'client_id': 'User_11', 'status': 1, 'shop_id': 'SHOP_47'}
...
2023-12-16 21:54:11.651 [DEBUG]: [smartshop-session] {'ts': 1702763651651, 'session_id': '646660cc080b4e32a0b391914c885702', 'client_id': 'User_11', 'status': -1, 'shop_id': 'SHOP_47'}
...
----------------------------------------
-- Aggregate Stream smartshop-basket --
----------------------------------------
...
------------------------------------
-- Ingest topic smartshop-session --
------------------------------------
CREATE TABLE `smartshop-session` (
  ...
  'kafka_topic' = 'smartshop-session',
  'key_format' = 'KAFKA',
  'value_format' = 'AVRO'
);

------------------------------------------
-- Show aggregate basket after check-in --
------------------------------------------
CREATE TABLE `smartshop-checkin-qty`
WITH (
  'kafka_topic' = 'smartshop-checkin-qty',
  'key_format' = 'KAFKA',
  'value_format' = 'AVRO'
) AS
SELECT
